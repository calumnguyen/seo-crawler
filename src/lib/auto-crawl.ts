...
export async function startAutomaticCrawl(
  ...
  addAuditLog(auditId, 'setup', `⏱️  Note: We will attempt to find ALL sitemaps (including nested sitemap indexes), which may take 4+ minutes. Please be patient.`, { baseUrl, note: 'sitemap-discovery-time' });
