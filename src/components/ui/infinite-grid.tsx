 ...
 * This is a simplified version with only the interactive grid background.
 */
export const InfiniteGrid = () => {
  ...
  return (
    <div
      ...
      className={cn(
        "fixed inset-0 w-full h-full flex flex-col items-center justify-center overflow-hidden bg-background"
      )}
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute right-[10%] top-[-10%] w-[20%] h-[20%] rounded-full bg-[var(--accent)]/30 blur-[100px]" />
